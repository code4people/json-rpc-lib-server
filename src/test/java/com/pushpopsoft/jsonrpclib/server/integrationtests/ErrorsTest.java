...
import com.pushpopsoft.jsonrpclib.binding.annotations.ErrorMapping;
...
import com.pushpopsoft.jsonrpclib.server.exceptions.CustomErrorException;
...
public class ErrorsTest {
    ...
    public static class Receiver {
        ...
        @Bind(paramsTypes = ParamsType.MISSING)
        @ErrorMapping(
                @com.pushpopsoft.jsonrpclib.binding.annotations.Error(code = 32000, exception = RuntimeException.class, message = "This is custom message")
        )
