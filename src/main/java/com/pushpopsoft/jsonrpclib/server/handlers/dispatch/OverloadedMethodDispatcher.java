...
import com.pushpopsoft.jsonrpclib.server.handlers.dispatch.resolvers.NamedParamsMethodResolver;
import com.pushpopsoft.jsonrpclib.server.handlers.dispatch.resolvers.PositionalParamsMethodResolver;
import com.pushpopsoft.jsonrpclib.server.handlers.methods.MissingParamsMethod;
import com.pushpopsoft.jsonrpclib.server.handlers.methods.NamedParamsMethod;
import com.pushpopsoft.jsonrpclib.server.handlers.methods.PositionalParamsMethod;

import java.util.HashMap;
import java.util.Map;

public class OverloadedMethodDispatcher implements MethodDispatcher {
    ...
    public OverloadedMethodDispatcher(PositionalParamsMethodResolver positionalParamsMethodResolver, NamedParamsMethodResolver namedParamsMethodResolver, MissingParamsMethod missingParamsMethod) {
